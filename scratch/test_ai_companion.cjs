...
class MockPromptBuilder {
  constructor() {
    this.systemPrompt = "You are a supportive, emotionally intelligent, human-like companion. Respond naturally like a close human friend.";
    this.rollingSummary = "User has exams coming up and is feeling anxious.";
    this.memories = "- [goal] (Importance: high): MCA degree completion";
  }
...
const testCases = [
  ...
  },
  {
    ...
    fallbackKey: "English" // Fallback fallback
  },
  {
